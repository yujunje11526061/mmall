...
public class actionScopeTest {
    ...
    public void test() {
        ...
        System.out.println("\nCase 2: 不同上下文的单例测试，可见不同上下文环境的单例是不一样的，spring的单例只对当前上下文有效");
        ...
        System.out.println("\nCase 5: 父单例、子多例测试，返回的父子都相同，因为父只有一个，取子比较必然是同一个");
        ...
        System.out.println("\nCase 6: 母单例，子多例的情况，通过方法产生孩子，而不是用属性记录，则每次返回的孩子都不一样，这是方法注入");
